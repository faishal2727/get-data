...
abstract class $RestaurantCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? name, String? description, String? city});
}
...
class _$_Restaurant with DiagnosticableTreeMixin implements _Restaurant {
  const _$_Restaurant({this.id, this.name, this.description, this.city});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Restaurant(id: $id, name: $name, description: $description, city: $city)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, description, city);
...
abstract class _Restaurant implements Restaurant {
  const factory _Restaurant(
      ...
      final String? name,
      final String? description,
      final String? city}) = _$_Restaurant;
